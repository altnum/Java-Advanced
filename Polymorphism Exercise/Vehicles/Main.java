...
public class Main {
    public static void main(String[] args) {
        ...
        vehicleMap.put("Vehicles.Car", new Car(Double.parseDouble(tokens[1]), Double.parseDouble(tokens[2])));

        tokens = scan.nextLine().split("\\s++");

        vehicleMap.put("Vehicles.Truck", new Truck(Double.parseDouble(tokens[1]), Double.parseDouble(tokens[2])));
