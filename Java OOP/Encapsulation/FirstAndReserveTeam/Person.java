...
public class Person {
    ...
    public void setAge(int age) {
        if (age <= 0) {
            throw new IllegalArgumentException("ValidationData.FirstAndReserveTeam.ShoppingSpree.DefineAnInterfacePerson.MultipleImplementation.BirthdayCelebrations.FoodShortage.Person age cannot be zero or negative integer");
        }
