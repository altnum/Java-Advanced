...
public abstract class BaseComputer extends BaseProduct implements Computer {
    ...
    public String toString() {
        ...
        builder.append(String.format(" " + COMPUTER_PERIPHERALS_TO_STRING, peripherals.size(), peripherals.stream().mapToDouble(Peripheral::getOverallPerformance).average().orElse(0)));
